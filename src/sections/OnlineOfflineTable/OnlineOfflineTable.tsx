...
const OnlineOfflineTable = () => {
    return (<section className="nuopen-table-section">
        <div className="nuopen-table">
            <div className="nuopen-table__head">
                <div className="nuopen-table__border nuopen-table__header-row">
                    ...
                    <div className="nuopen-table__header">
                        <span className="nuopen-table__highlighted">online</span> participation
                    </div>
                    <div className="nuopen-table__header">
                        <span className="nuopen-table__highlighted">offline</span> participation
                    </div>
                </div>
            </div>
            <div className="nuopen-table__body">
                ...
                <div
                    className=" nuopen-table__data nuopen-table__smaller-text"
                >
                ...
                <img alt={"Yes"} className="nuopen-table__grid-element" src={galochka}/>
                <img alt={"Yes"} className="nuopen-table__grid-element" src={galochka}/>
